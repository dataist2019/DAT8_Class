...
print b
print b.prettify() #it indents the lines
...
results = b.find('ul', id='api').find_all('li')
for tag in results:
    print tag.text
...
b.find('span', attrs={'class':'itemprop', 'itemprop':'name'}).text
b('span', 'itemprop')
# get the star rating
b('span', itemprop='ratingValue')
'''
EXERCISE TWO
'''

# get the description
b.find('p', itemprop='description').text.strip()
# get the content rating
b.find('meta', itemprop='contentRating')
b.find('div', 'infobar').find_all('meta')
